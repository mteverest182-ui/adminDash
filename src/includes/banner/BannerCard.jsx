...
// import { getBannerSlotLabel } from "./BannerSlotOptions";
...
//     const previewImage = desktopImage || mobileImage;
//     const previweDevice = desktopImage ? "Desktop" : mobileImage ? "Mobile" : null;

//     return (
//         <div className="overflow-hidden rounded-2xl border border-base-300 bg-base-100 shadow-sm">
//             <div className="flex min-h-52 items-center justify-center overflow-hidden bg-base-200 p-2">
//                 {previewImage ? (
//                     <img 
//                     src={previewImage.imageUrl}
//                     alt={`${banner.title}= ${previweDevice}`}
//                     className="max-h-80 w-full object-contain"
//                     />
//                 ): (
//                     <div className="flex h-52 item-center justify-center text-sm text-base-content/40">
//                         No Image
//                     </div>
...
//                     <span
//                     className={`badge 
//                         ${banner.status === "ACTIVE" ? "badge-success" : "badge-ghost"}`}
//                     >
//                         {banner.status}
//                     </span>
//                 </div>
...
//                     <button type="button" className="btn btn-sm btn-outline flex-1"  onClick={() => onStatusChange(banner)}> {banner.status === "ACTIVE" ? "Deactive" : "Activate"} </button>
//                     <button type="button" className="btn btn-sm btn-outline" onClick={() => onEdit(banner)}> Edit </button>
//                     <button type="button" className="btn btn-sm btn-error" onClick={() => onDelete(banner)}>Delete</button>
//                 </div>
//             </div>
//         </div>
//     );
